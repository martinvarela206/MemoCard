...
- **[src/components/FlashCard.jsx](../src/components/FlashCard.jsx)**: Tarjeta interactiva con giro 3D, compilación matemática KaTeX en títulos (`card-term`, `card-mini-title`) y badges de subtema, área vertical maximizada (sin pie de tarjeta redundante), soporte multimedia (`CardMedia`), badges de secuencia de derivación por pasos (`Paso X de Y`) e insignias de tags transversales.
