...
**Definición:** Una **sucesión finita** es una secuencia de n elementos, donde el orden importa. Esta secuencia esta determinada por una función con **dominio** en el conjunto finito **$\{1,2,3,...,n\}$** que determinan la posición que ocupa el elemento y **codominio $S$** en el conjunto de elementos que van a componer dicha secuencia, tal que:

**$f : \{1,2,3,...,n\} \to S$** define para cada elemento la posición que ocupa.

---

### Diapositiva 3: Propiedades de las Sucesiones

- En **sucesiones**, la secuencia $abc$ es distinta de la secuencia $bca$.
- Como más de un elemento del dominio puede tener la misma imagen, entonces las secuencias pueden repetir elementos en distintas posiciones.
- Como es una función entre conjuntos, si el conjunto dominio esta vacío, entonces la sucesión puede ser vacía.

---

### Diapositiva 4: Cadena o palabra ($w$)
...
### Diapositiva 5: Cadena vacía o nula ($\epsilon$)
...
### Diapositiva 7: Clausura de Kleene de un Alfabeto ($\Sigma^*$)
...
### Diapositiva 8: Clausura Positiva de un Alfabeto ($\Sigma^+$)
...
### Diapositiva 10: Operaciones y Relaciones sobre Cadenas (son 5)
...
### Diapositiva 12: Operaciones sobre Cadenas: Potencia $k$-ésima de una cadena ($w^k$)
...
### Diapositiva 14: Relaciones entre Cadenas: Subcadena
...
### Diapositiva 15: Relaciones entre Cadenas: Prefijo y Sufijo
...
### Diapositiva 16: Las cadenas tienen 9 propiedades y estas son:
...
### Diapositiva 17: Propiedad de las cadenas 1 de 9: Longitud no negativa
...
### Diapositiva 18: Propiedad de las cadenas 2 de 9: Longitud nula = $\epsilon$
...
### Diapositiva 19: Propiedad de las cadenas 3 de 9: Aditividad de longitud en la concatenación
...
### Diapositiva 20: Propiedad de las cadenas 4 de 9: Longitud de subcadena
...
### Diapositiva 22: Propiedad de las cadenas 6 de 9: Asociatividad en la concatenación
...
### Diapositiva 23: Propiedad de las cadenas 7 de 9: No conmutatividad en la concatenación
...
### Diapositiva 25: Propiedad de las cadenas 9 de 9: Concatenación nula
...
### Diapositiva 27: Casos Especiales de Lenguajes (2)
...
---
### Diapositiva 28: Representaciones de los Lenguajes (3)
...
---
### Diapositiva 29: Representación de un Lenguaje: Por Extensión
...
---
### Diapositiva 30: Representación de un Lenguaje: Por Comprensión
...
---
### Diapositiva 31: Representación de un Lenguaje: Con Parámetros
...
- Se deben usar términos como: *"tiene longitud"*, *"tiene prefijo..."*, *"tiene sufijo..."*, etc.
...
### Diapositiva 34: Representación con Parámetros: Prefijos y Sufijos que se Solapan - Regla

Cuando un lenguaje exige que sus cadenas tengan un prefijo $P$ y un sufijo $S$, que pueden solaparse o ser idénticos, $w = X \alpha X$ no es suficiente, ya que omite la cadena mínima ($w=X$ cuando $\alpha=\epsilon$).
En estos casos hay que añadir por **unión de conjuntos**, la cadena mínima.

---

### Diapositiva 35: Representación con Parámetros: Prefijos y Sufijos que se Solapan - Casos
...
### Diapositiva 36: Representación con Parámetros: Solapamientos complejos

Cuando un lenguaje requiere prefijo, subcadena y sufijo que puede solaparse completamente, entonces hay que considerar todos los casos bases que pueden darse: $L$ esta formado por cadenas con prefijo $bem$, subcadena $emma$ y sufijo $ma$.
1. Cadenas sin solapamiento: $\{w \in \Sigma^* \mid w = bem\alpha emma \beta ma, \alpha, \beta \in \Sigma^*\}$
2. Solapamiento del prefijo y la subcadena: $\cup \{bemma\delta, \delta \in \Sigma^*\}$
3. Solapamiento de la subcadena y sufijo: $\cup \{bem\gamma emma, \gamma \in \Sigma^*\}$
4. Solapamiento total: $\cup \{bemma\}$

---

### Diapositiva 37: Representación con Parámetros: Longitudes Pares e Impares

Para definir la longitud de las cadenas o partes de ellas por medio de parámetros hay que utilizar potencias variables de la forma:
- **Longitud Par ($|w|$ es par):**
  - $L = \{w \in \Sigma^* \mid w = \alpha, \alpha \in \Sigma^{2k}, k \ge 0\}$
- **Longitud Impar ($|w|$ es impar):**
  - $L = \{w \in \Sigma^* \mid w \in \Sigma^{2k+1}, k \ge 0\}$

---

### Diapositiva 38: Representación con Parámetros: Longitudes Múltiplos

**Definición:** Para representar múltiplos sin lenguaje coloquial, se define el conjunto de cadenas de longitud múltiplo de un número entero:
- **Longitud múltiplo de $m$:**
  - $L = \{w \in \Sigma^* \mid w = \alpha, \alpha \in (\Sigma^m)^*\}$

---
### Diapositiva 39: Operaciones con Lenguajes (8)
...
### Diapositiva 40: Operaciones con Lenguajes: Unión
...
### Diapositiva 41: Operaciones con Lenguajes: Intersección
...
### Diapositiva 42: Operaciones con Lenguajes: Diferencia (resta)
...
### Diapositiva 43: Operaciones con Lenguajes: Complemento
...
### Diapositiva 44: Operaciones con Lenguajes: Concatenación
...
### Diapositiva 45: Operaciones con Lenguajes: Potencia $k$-ésima de un Lenguaje
...
---
### Diapositiva 46: Operaciones con Lenguajes: Clausuras (2)
...
---
### Diapositiva 47: Operaciones con Lenguajes: Clausura de Kleene de un Lenguaje ($L^*$)
...
---
### Diapositiva 48: Operaciones con Lenguajes: Clausura Positiva de un Lenguaje ($L^+$)
...
---
### Diapositiva 49: Relaciones entre $L^*$, $L^+$ y $\{\epsilon\}$
...
En cambio, los lenguajes son conjuntos de cadenas, y $\epsilon$ es una cadena, entonces un lenguaje puede contener a $\epsilon$, por lo tanto la clausura positiva de un lenguaje PUEDE contener a $\epsilon$.
...
* **Propiedad 12 — Relación con la Clausura de Kleene:**
  $$L^+ = LL^* = L^*L$$
> Recordar que para la clausura de alfabetos, las relaciones son $\epsilon$ dependientes.
---
...
Una **descripción finita** consiste aplicar a una serie de **lenguajes básicos** solo ciertas **operaciones**, un número finito de veces. Esto permite obtener un **Lenguaje Regular**.

---

### Diapositiva 64: Definición Formal de Lenguaje Regular (LR)

Un **Lenguaje Regular (LR)** es un conjunto $L \subseteq \Sigma^*$ definido inductivamente:
1. **Base:** $\emptyset$, $\{\epsilon\}$ y $\{a\}$ (para cada $a \in \Sigma$) son lenguajes regulares.
2. **Paso Inductivo:** Si $L_1$ y $L_2$ son regulares, entonces:
   - $L_1 \cup L_2$ (unión), $L_1 L_2$ (concatenación) y $L_1^*$ (clausura) son regulares.
3. **Clausura extrema:** Ningún otro lenguaje sobre $\Sigma$ es regular.

> Es un objeto **semántico** (conjunto de palabras, se escribe con llaves).

---

### Diapositiva 65: Lenguaje Regular: Definiciones Equivalentes (Teorema de Kleene)

Un lenguaje $L \subseteq \Sigma^*$ es **regular** si y sólo si cumple cualquiera de estas equivalencias:
1. **Expresiones Regulares:** Es denotado por alguna ER ($L = L(E)$).
2. **Autómatas Finitos:** Es aceptado por algún AFD, AFND o AFND-$\epsilon$.
3. **Gramáticas:** Es generado por alguna Gramática Regular (Tipo 3).

> **Clave de examen:** Estas 3 vías de formalización son totalmente equivalentes.

---
### Diapositiva 66: Lenguajes Regulares finitos o infinitos
...
### Diapositiva 67: Propiedades de los Lenguajes Regulares sobre Operaciones (6)
...
### Diapositiva 68: Generalización de las Propiedades de los Lenguajes Regulares sobre Operaciones (3)
...
### Diapositiva 69: Lenguajes NO Regulares
...
### Diapositiva 70: Ejemplo de Lenguajes No Regulares (Conteo Infinito)

$$L_1=\{a^i b^i\mid i\in\mathbb{N}\}$$

Este ejemplo no es regular, ya que, aunque individualmente se puede evaluar $a^*$ y $b^*$, y su concatenación, el problema surge de que no son independientes, es decir que ambas cantidades deben ser iguales, y esto requiere de un conteo potencialmente infinito, algo que los AF no pueden hacer.

---

### Diapositiva 71: Ejemplos de Lenguajes No Regulares (Conteo Acumulativo Infinito)
...
### Diapositiva 72: Ejemplos de Lenguajes No Regulares (Ausencia de regularidad)
$$L_3 = \{\text{palabras que son sufijos de la expansión decimal del número } \pi\}$$
$$\text{ Sobre }\Sigma = \{0, 1, \dots, 9\}$$

Dado que la secuencia de símbolos no es periodica, son necesarias infinitas operaciones de union de nuevos símbolos, para obtener las palabras resultantes. No se puede hacer con las operaciones dadas.

---

### Diapositiva 73: Definición Formal de Expresión Regular (ER)

Una **Expresión Regular (ER)** es una fórmula sintáctica sobre $\Sigma \cup \{\emptyset, \epsilon, +, \cdot, *, (, )\}$:
1. **Base:** Los símbolos $\emptyset$, $\epsilon$ y $a$ (para cada $a \in \Sigma$) son ER.
2. **Paso Inductivo:** Si $E_1$ y $E_2$ son ER, entonces:
   - $(E_1 + E_2)$ (alternativa), $(E_1 E_2)$ (concatenación) y $(E_1)^*$ (clausura) son ER.
3. **Clausura extrema:** Ninguna otra secuencia de caracteres es una ER.

> Es un objeto **sintáctico** (una fórmula/patrón, no lleva llaves de conjuntos).

---

### Diapositiva 74: Frontera Teórica: Lenguaje Regular vs Expresión Regular

**¿Dónde empieza y termina cada definición?**
* **Expresión Regular (ER) = SINTAXIS:**
  - Fórmula/patrón de caracteres: $\emptyset, \epsilon, a, +, \cdot, *$. Sin llaves.
* **Lenguaje Regular (LR) = SEMÁNTICA:**
  - Conjunto de palabras ($L \subseteq \Sigma^*$): $\emptyset, \{\epsilon\}, \{a\}, \cup, \cdot, *$. Con llaves.
* **El Puente:** La función $L(E)$ mapea la fórmula al conjunto denotado.

> **Regla de oro:** La ER es la notación; el LR es el conjunto denotado.

---

### Diapositiva 75: Pregunta de Examen: Defina Lenguaje Regular y Expresión Regular

**¿Qué responder si preguntan 'Defina LR y Defina ER' en el examen?**
1. **Para Lenguaje Regular:** Dar la definición por conjuntos: base $\emptyset, \{\epsilon\}, \{a\}$ y clausura bajo $\cup, \cdot, *$. (O equivalencia: $L=L(E)$ o aceptado por AF).
2. **Para Expresión Regular:** Dar la definición sintáctica inductiva: símbolos base $\emptyset, \epsilon, a$ y operaciones $(E_1 + E_2), (E_1 E_2), (E_1)^*$.

> **Errores fatales a evitar:** Jamás definir una ER con llaves $\{\}$, ni definir un LR usando el operador de suma $+$. Uno es conjunto, el otro es sintaxis.

---

### Diapositiva 76: Operaciones de las ERs

Si $E$ es una ER, entonces:
- Su forma agrupada es una ER: $(E)$
- La concatenación de ERs es una ER: $E_1 E_2$
- La suma de ERs es una ER: $(E_1 + E_2)$
- La clausura de Kleene es una ER: $(E)^*$
- La clausura positiva no es una operación para las ERs.

---

### Diapositiva 77: Lenguajes generados por ER elementales
...
### Diapositiva 78: Lenguajes generados por operaciones de las ER
...
### Diapositiva 79: Prioridad de Operaciones en ER
...
### Diapositiva 80: Expresiones Regulares Equivalentes
...
### Diapositiva 81: Guía Práctica de Construcción de Expresiones Regulares - Parte 1
...
### Diapositiva 82: Construcción de ERs: Ejemplos 1
...
### Diapositiva 83: Construcción de ERs: Ejemplos 2
...
### Diapositiva 84: Construcción de ERs: Ejemplos 3
...
### Diapositiva 85: Construcción de ERs: Ejemplos 4
...
### Diapositiva 86: Construcción de ERs: Ejemplos 5
...
> En $L_9$ los números naturales no comienzan con $0$ salvo el propio $0$. En $L_8$ ninguno puede comenzar por $0$.
...
### Diapositiva 87: Gramática ($G$): Definición algebraica
...
### Diapositiva 88: Convenciones de Notación en Gramáticas
...
- **Símbolos Terminales ($\in \Sigma$):** Letras minúsculas $a, b, c, \dots, x, y, z$. Se utilizan $x, y, z$ como comodines.
- **Cadenas de Terminales ($\in \Sigma^*$):** Se representan con la letra $w$.
- **Cadenas Mixtas ($\in (N \cup \Sigma)^*$):** Se representan con letras griegas $\alpha, \beta, \gamma, \delta, \pi, \rho$ (y la cadena vacía con $\epsilon$).

---

### Diapositiva 89: Definición de las reglas de producción
...
### Diapositiva 90: Cabeza y Cuerpo de las reglas de producción

Las reglas de producción tienen dos partes:
- **Cabeza ($\alpha$):** $\alpha \in (N \cup \Sigma)^* N (N \cup \Sigma)^*$
> Es decir, que la cabeza es una cadena con al menos tiene un símbolo no terminal.
- **Cuerpo ($\alpha'$):** $\alpha' \in (N \cup \Sigma)^*$
> Es decir, que el cuerpo es una cadena con cualquier número de símbolos terminales y/o no terminales, o bien la cadena vacía.

---

### Diapositiva 91: Notación de Backus
...
### Diapositiva 92: Relación Deriva
...
### Diapositiva 93: Derivación Directa
...
### Diapositiva 94: Derivación en múltiples pasos
...
### Diapositiva 95: Forma Sentencial
...
### Diapositiva 97: Lenguaje Generado por una Gramática ($L(G)$)
...
### Diapositiva 98: Lenguaje Inverso ($L^{-1}(G)$)
...
### Diapositiva 99: Gramáticas de lenguajes inversos
...
### Diapositiva 100: Gramática de Estructura de Frase
...
### Diapositiva 101: Casos especiales de reglas de producción
...
### Diapositiva 102: Contraejemplo de Gramática de Estructura de Frase
...
### Diapositiva 103: Jerarquía de Chomsky: Clasificación General
...
### Diapositiva 104: Jerarquía: Gramática Tipo 0 (Irrestrictas)
...
### Diapositiva 105: Jerarquía: Gramática Tipo 1 (Dependientes del Contexto)
...
### Diapositiva 106: Jerarquía: Gramática Tipo 2 (Libres de Contexto)
...
### Diapositiva 107: Jerarquía: Gramática Tipo 3 (Regulares)
...
### Diapositiva 108: Impacto de la Regla no generativa ($S \to \epsilon$)
...
### Diapositiva 109: Grafo Asociado a una Gramática Regular Lineal por Derecha
...
### Diapositiva 110: Grafo Asociado a una Gramática Regular Lineal por Izquierda
...
### Diapositiva 111: Definición de Aristas del Grafo Asociado a una Gramática Regular
...
### Diapositiva 112: Árbol de Derivación (Árbol de Parser)
...
### Diapositiva 113: Gramática Ambigua
...
### Diapositiva 114: Construcción del Árbol de Derivación
...
### Diapositiva 115: Lectura del Árbol de Derivación (Frontera)
